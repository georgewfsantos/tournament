...
import Bracket4player from '../models/Bracket4player';

class Bracket4PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket4player.create({
        ...req.body,
      });
...
export default new Bracket4PlayerController();
