...
import Bracket11player from '../models/Bracket11player';

class Bracket11PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket11player.create({
        ...req.body,
      });
...
export default new Bracket11PlayerController();
