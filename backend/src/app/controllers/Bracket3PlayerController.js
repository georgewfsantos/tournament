...
import Bracket3player from '../models/Bracket3player';

class Bracket3PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket3player.create({
        ...req.body,
      });
...
export default new Bracket3PlayerController();
