...
import Bracket5player from '../models/Bracket5player';

class Bracket5PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket5player.create({
        ...req.body,
      });
...
export default new Bracket5PlayerController();
