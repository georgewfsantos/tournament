...
import Bracket2player from '../models/Bracket2player';

class Bracket2PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket2player.create({
        ...req.body,
      });
...
export default new Bracket2PlayerController();
