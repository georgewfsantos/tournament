...
import Bracket7player from '../models/Bracket7player';

class Bracket7PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket7player.create({
        ...req.body,
      });
...
export default new Bracket7PlayerController();
