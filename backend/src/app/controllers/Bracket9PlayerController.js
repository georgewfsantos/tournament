...
import Bracket9player from '../models/Bracket9player';

class Bracket9PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket9player.create({
        ...req.body,
      });
...
export default new Bracket9PlayerController();
