...
import Bracket12player from '../models/Bracket12player';

class Bracket12PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket12player.create({
        ...req.body,
      });
...
export default new Bracket12PlayerController();
