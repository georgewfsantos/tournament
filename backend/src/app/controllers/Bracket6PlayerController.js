...
import Bracket6player from '../models/Bracket6player';

class Bracket6PlayerController {
  async store(req, res) {
    ...
    try {
      const bracket_1 = await Bracket6player.create({
        ...req.body,
      });
...
export default new Bracket6PlayerController();
